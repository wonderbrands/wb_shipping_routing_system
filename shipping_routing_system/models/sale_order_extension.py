...
class SaleOrder(models.Model):
    ...
    zip_code_shipper = fields.Char(string="C.P Origen", readonly=False)
    zip_code_recipient = fields.Char(string="C.P Destino", readonly=False)
    wb_srs_flag = fields.Boolean(string='¿Procesado por SRS?',default=False, readonly=False) #
